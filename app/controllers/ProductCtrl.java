...
public class ProductCtrl extends Controller {
    ...
    public Result index() {
        return redirect(routes.ProductCtrl.shop(0,""));
    }
    ...
    @Transactional
    public Result shop(Long cat, String filter) {
        ...
        return ok(shop.render(products,categories, cat, filter, getCurrentUser(),e));
    }
