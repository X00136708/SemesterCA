...
insert into product (id,name,description,stock,price) values ( 1,'Grand Theft Auto V','When a young street hustler, a retired bank robber and a... ',100,49.00 );
insert into product (id,name,description,stock,price) values ( 2,'FIFA 18','From tiki-taka to high press, new Team Styles put the most recognised... ',45,44.99 );
