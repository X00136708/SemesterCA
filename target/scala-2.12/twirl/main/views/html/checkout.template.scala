...
<script>
	...
	function confirmDel() """),format.raw/*104.24*/("""{"""),format.raw/*104.25*/("""
		"""),format.raw/*105.3*/("""return confirm('Are you sure?');
