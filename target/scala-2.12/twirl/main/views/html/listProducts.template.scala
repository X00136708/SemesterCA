      ...
      <tbody>
        """),_display_(/*49.10*/for(p<-products) yield /*49.26*/ {_display_(Seq[Any](format.raw/*49.28*/("""
          """),format.raw/*50.11*/("""<tr>
            ...
            """),format.raw/*57.13*/("""<td><a href=""""),_display_(/*57.27*/routes/*57.33*/.ProductCtrl.productDetails(p.getId)),format.raw/*57.69*/("""">
