                 ...
                 <p>
                    ...
                    """),_display_(/*91.22*/if(user != null)/*91.38*/{_display_(Seq[Any](format.raw/*91.39*/("""
                      """),_display_(/*92.24*/if("admin".equals(user.getRole()))/*92.58*/{_display_(Seq[Any](format.raw/*92.59*/("""
                        """),format.raw/*93.25*/("""<div id="prodPegi">"""),_display_(/*93.45*/p/*93.46*/.getPegi),format.raw/*93.54*/("""</div>
                    """)))}/*94.22*/else/*94.26*/{_display_(Seq[Any](format.raw/*94.27*/("""
                      """),format.raw/*95.23*/("""<br><div id="prodPegi">"""),_display_(/*95.47*/p/*95.48*/.getPegi),format.raw/*95.56*/("""</div>
                    """)))}),format.raw/*96.22*/("""
                  """)))}/*97.20*/else/*97.24*/{_display_(Seq[Any](format.raw/*97.25*/("""
                    """),format.raw/*98.21*/("""<br><div id="prodPegi">"""),_display_(/*98.45*/p/*98.46*/.getPegi),format.raw/*98.54*/("""</div>
                  """)))}),format.raw/*99.20*/("""
                  """),format.raw/*100.19*/("""</p>
