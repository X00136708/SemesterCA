    ...
    <div class="col-sm-6">
      ...
      """),format.raw/*61.7*/("""<div class="list-group">
          """),_display_(/*62.12*/for(p<-products) yield /*62.28*/ {_display_(Seq[Any](format.raw/*62.30*/("""
              ...
              <!-- <td  class="numeric">"""),_display_(/*96.42*/p/*96.43*/.getStock),format.raw/*96.52*/("""</td>
              <td  class="numeric">€ """),_display_(/*97.39*/("%.2f".format(p.getPrice))),format.raw/*97.66*/("""</td>
              
              <td><a href=""""),_display_(/*99.29*/routes/*99.35*/.AdminProductCtrl.updateProduct(p.getId)),format.raw/*99.75*/("""" class="button xs btn-danger">
                    <span class="glyphicon glyphicon-pencil"></span>
                  </a>
                </td>        
              <td><a href=""""),_display_(/*103.29*/routes/*103.35*/.AdminProductCtrl.deleteProduct(p.getId)),format.raw/*103.75*/("""" class="button xs btn-danger" onclick="return confirmDel();">
