        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li """),_display_(/*37.22*/if(title=="Login")/*37.40*/{_display_(Seq[Any](format.raw/*37.41*/("""class="active"""")))}),format.raw/*37.56*/(""">
                    ...
                    """)))}),format.raw/*42.22*/("""
                    """),_display_(/*43.22*/if(user.getRole=="registeredUser")/*43.56*/{_display_(Seq[Any](format.raw/*43.57*/("""
                """),format.raw/*44.17*/("""<li>
                    <a href="#">Wallet</a>
                </li>
            """)))}),format.raw/*47.14*/("""
